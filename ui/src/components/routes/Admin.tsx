...
const Admin = () => {
  ...
  function fillUpForm(projectFill: Project) {
    setErrorMsg('');
    setSuccessMsg('');
    setTitle(projectFill.title);
    setLink(projectFill.link);
    setDescription(projectFill.description);
    setTags(projectFill.tag);
    setVersion(projectFill.version);
  }
